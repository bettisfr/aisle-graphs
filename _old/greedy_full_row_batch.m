function greedy_full_row_batch(input, min_budget, step_budget, max_budget)
...
%     for budget=min_budget:step_budget:max_budget+step_budget
    for i=1:size(budgets,2)
        ...
        [b, c, r] = greedy_full_row(input, budget);
    ...
    out_filename = sprintf('C:\\Users\\franc\\Desktop\\droneranging\\papers\\ICRA 2020\\robots\\output\\gfr\\out_gfr-%d.txt', input);
